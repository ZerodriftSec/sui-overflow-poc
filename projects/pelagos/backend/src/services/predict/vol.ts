 ...
 *
 * Predict prices every market off a per-oracle SVI vol surface. The read facade
 * exposes the raw-SVI total-variance params per oracle in the shape
 ...
 * oracle's own. Nothing here is fabricated; it is the protocol's surface.
 */
...
/** Decode fixed-point on-chain SVI values: /1e9, applying rho/m sign flags. */
