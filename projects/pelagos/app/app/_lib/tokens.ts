...
export const FS = "var(--font-inter), system-ui, sans-serif";
export const FD = "var(--font-inter), system-ui, sans-serif";
export const FM = "var(--font-jetbrains-mono), 'SF Mono', Menlo, monospace";
