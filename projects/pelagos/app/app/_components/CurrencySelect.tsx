...
// book. dUSDC is Predict's native quote asset; mUSDC is Pelagos's freely
// mintable testnet settlement asset.
const CURRENCY_NOTE: Record<Currency, string> = {
  dUSDC: "Native · DeepBook Predict",
  mUSDC: "Pelagos USDC · testnet",
};

const DEFAULT_CURRENCIES: readonly Currency[] = ["dUSDC", "mUSDC"];
...
export function CurrencySelect({
  ...
  // Move keyboard focus into the listbox once it has been mounted. The active
  // option is seeded by the click handler that opens the list.
  useEffect(() => {
    if (!open) return;
