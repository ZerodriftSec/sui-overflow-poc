...
const GRANTS: Array<{ asset: string; amount: string; use: string; color: string }> = [
  ...
  { asset: "mUSDC", amount: "10,000", use: "Pelagos USDC · testnet settlement, 1:1 USD", color: C.blue },
  { asset: "SUI", amount: "3", use: "Gas — enough to sign across products", color: C.violet },
];
