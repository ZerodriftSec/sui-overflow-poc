...
import { ReclaimIdle } from "./ReclaimIdle";
    ...
    <>
      <style>{`
        ...
        @media (max-width: 980px) {
          .pelagos-header-nav { display: none !important; }
        }
        @media (max-width: 700px) {
          .pelagos-header { padding-left: 12px !important; padding-right: 12px !important; gap: 8px !important; }
          .pelagos-header-left { flex: 0 0 auto !important; gap: 0 !important; }
          .pelagos-brand-word { display: none !important; }
          .pelagos-header-actions { gap: 6px !important; min-width: 0 !important; }
          .pelagos-header-optional { display: none !important; }
        }
      `}</style>
      <header className="pelagos-header" style={{
        position: "sticky",
        top: 0,
        zIndex: 100,
        ...
        <div className="pelagos-header-left" style={{ display: "flex", alignItems: "center", gap: 24, flex: 1, minWidth: 0 }}>
          <Link href="/" aria-label="Pelagos home" style={{ display: "flex", alignItems: "center", gap: 9, textDecoration: "none", flexShrink: 0 }}>
            <PelagosMark />
            <span className="pelagos-brand-word" style={{ fontSize: 13, fontWeight: 600, color: C.textPrimary, fontFamily: FD, letterSpacing: "0.14em" }}>
              PELAGOS
            </span>
          </Link>

          <nav className="pelagos-header-nav" style={{
            display: "flex",
            alignItems: "center",
            gap: 18,
            overflowX: "auto",
        ...
        <div className="pelagos-header-actions" style={{ display: "flex", alignItems: "center", gap: 10, flexShrink: 0 }}>
          <ModeToggle />
          <div className="pelagos-header-optional"><ThemeToggle /></div>
          <div className="pelagos-header-optional"><TestnetBadge /></div>
          <div className="pelagos-header-optional"><ReclaimIdle /></div>
          <div className="pelagos-header-optional"><HeaderFaucet /></div>
