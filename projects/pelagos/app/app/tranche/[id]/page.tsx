  ...
  const steps: Array<{ num: string; title: string; body: string }> = [
    {
      num: "01",
      title: "Buy in",
      body: `Pick a tranche, enter USDC, and confirm. You get ${kind} units at the quoted price, which already includes fees and live event-book slippage.`,
    },
    {
      num: "02",
      title: "Wait it out",
      body: `The basket's underlying event positions resolve over its lifetime. Your tokens stay liquid throughout, so you can exit early or hold to maturity.`,
    },
    {
      num: "03",
      title: "Redeem",
