...
import { ModeProvider } from "./app/_lib/mode";
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    ...
    >
      ...
      <body>
        <ThemeProvider>
          {/* ModeProvider lives at the ROOT (not just /app) so the shared Header's
              Basic/Advanced toggle is bound to a provider on the marketing landing
              too — otherwise its clicks were inert outside /app. Single source of
              truth, localStorage-synced across landing + app. */}
          <ModeProvider>
