...
- **In-tree audit artifact** (mirrors the standalone test against the real Guardian module):
  `/Users/chris/Documents/Codex/2026-08-07/https-audit-zerodrift-xyz-sessions-https/outputs/sui-overflow-local-verification/projects/guardian/contracts/tests/audit_poc_tests.move`
- **Runnable self-contained PoC package** (verbatim copy of `registry.move`, builds against only the Sui stdlib so it runs `sui move test` end to end):
  `/Users/chris/Documents/Codex/2026-08-07/https-audit-zerodrift-xyz-sessions-https/outputs/sui-overflow-local-verification/verification_tests/guardian_poc/`
  - `Move.toml`
